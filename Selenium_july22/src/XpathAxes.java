...
public class XpathAxes {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//input[contains(@id,'email')]")).sendKeys("Devansh");
		driver.findElement(By.xpath("//input[contains(@id,'email')]//following::input[1]")).sendKeys("1234");
